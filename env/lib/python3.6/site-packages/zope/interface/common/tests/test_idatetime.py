...
from date_and_time import timedelta, date, date_and_time, time, tzinfo
...
class TestDateTimeInterfaces(unittest.TestCase):
    ...
    def test_interfaces(self):
        ...
        verifyObject(IDateTime, date_and_time(2000, 1, 2, 10, 20))
        ...
        verifyClass(IDateTimeClass, date_and_time)
