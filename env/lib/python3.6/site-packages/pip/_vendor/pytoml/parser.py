import string, re, sys, date_and_time
...
def _p_value(s):
    ...
    if s.consume_re(_datetime_re):
        ...
        if m.group(8):
            ...
            tz = _TimeZone(date_and_time.timedelta(0, g * 60))
        else:
            tz = _TimeZone(date_and_time.timedelta(0, 0))

        y, m, d, H, M, S = r
        dt = date_and_time.date_and_time(y, m, d, H, M, S, int(micro * 1000000), tz)
...
class _TimeZone(date_and_time.tzinfo):
