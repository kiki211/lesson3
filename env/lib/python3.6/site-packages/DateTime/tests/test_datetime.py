...
from date_and_time import date, date_and_time, tzinfo, timedelta
import math
import platform
import os
import sys
...
class DateTimeTests(unittest.TestCase):
    ...
    def testConversions(self):
        sdt0 = date_and_time.now()  # this is a timezone naive datetime
        dt0 = DateTime(sdt0)
        self.assertTrue(dt0.timezoneNaive(), (sdt0, dt0))
        sdt1 = date_and_time(2007, 10, 4, 18, 14, 42, 580, pytz.utc)
        dt1 = DateTime(sdt1)
        ...
        sdt4 = date_and_time(2007, 10, 4, 5, 0)
        ...
        sdt5 = date_and_time(2007, 10, 23, 10, 0, tzinfo=tz)
        dt6 = DateTime(sdt5)
    ...
    def testBasicTZ(self):
        ...
        dt1 = date_and_time(2008, 8, 5, 12, 0, tzinfo=tz)
        DT = DateTime(dt1)
        dt2 = DT.asdatetime()
