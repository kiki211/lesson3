...
class DateTime(object):
    ...
    def _parse_args(self, *args, **kw):
        ...
        if ac == 10:
            ...
            elif isinstance(arg, date_and_time):
    ...
    def strftime(self, format):
        ...
        if isinstance(format, explicit_unicode_type):
            ...
            unicode_format = True
        ds = date_and_time(zself._year, zself._month, zself._day, zself._hour,
    ...
    def asdatetime(self):
        ...
        dt = date_and_time(self._year, self._month, self._day, self._hour,
    ...
    def utcdatetime(self):
        ...
        dt = date_and_time(utc._year, utc._month, utc._day, utc._hour,
